...
\begin{axis}[
  ...
  xmin=-0.4, xmax=8.6, ymin=24.5, ymax=39.8,
  xtick={0,1,2,4,8}, ytick={26,28,30,32,34,36,38},
...
\addlegendentry{selector (frozen $\pi_0$)}
\addplot[accB, very thick, mark=square*, mark size=2.0pt]
  coordinates {(0,28.2) (1,26.5) (2,26.5) (4,30.2) (8,29.9)};
\addlegendentry{Recent-$B$}
% note (luojiaxuan): 主设置 B=4 的完整 CausalCache(HGKV+selector)单点星标。
\addplot[accO, only marks, mark=star, mark size=3.6pt, very thick]
  coordinates {(4,36.8)};
\addlegendentry{\textsc{CausalCache} ($B{=}4$)}
% B=4 主设置直标
\node[font=\small, text=accO, anchor=south] at (axis cs:4,37.1) {36.8};
\node[font=\small, text=accO, anchor=north west] at (axis cs:4.12,34.1) {33.9};
