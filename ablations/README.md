...
| [Subset search](subset_search.md) | JSON round-trip fix pending push；canonical rerun pending | exact、true conditional greedy、bounded exchange 与 beam 的 search regret/query cost，以及它与 averaged-score projection gap 的区别 |
