...
| [Subset search](subset_search.md) | canonical CPU result 与 committed validation complete | exact、true conditional greedy、bounded exchange 与 beam 的 search regret/query cost，以及它与 averaged-score projection gap 的区别 |
