...
CUDA_VISIBLE_DEVICES=0 nohup python3 code/scripts/score_sparse_history_arms.py \
  --repository-root . \
  --config code/configs/causalcache_desktop_did_full_lora_v5_selected.json \
...
wait
echo "FULLLORA_DEVSCORE_BOTH_DONE $(date -u +%H:%M)"
