#!/usr/bin/env python3
"""Build or validate the source-only strict-determinism D2 contract."""
...
def main() -> None:
    ...
    if args.emit_skeleton:
        payload = build_action_stability_source_v3_config_skeleton(
        ...
        payload = validate_action_stability_source_v3_config(
