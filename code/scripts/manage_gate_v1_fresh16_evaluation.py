#!/usr/bin/env python3
"""Validate, freeze, execute, or replay the fresh-16 primary gate evaluation."""
...
from causalcache.gate_v1_fresh16_evaluation_runner import (
...
def _run(args: argparse.Namespace) -> Mapping[str, Any]:
    ...
    if args.command == "validate-source":
        source_only = validate_fresh16_evaluation_source_only_contract(
            args.contract,
            repository_root=args.repository_root,
        )
        return {
    ...
    return execute_fresh16_evaluation(
        mode=args.command,
        contract=contract,
        api=api,
