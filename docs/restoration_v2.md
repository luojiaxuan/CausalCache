...
[`restoration_v2_ocr.md`](restoration_v2_ocr.md)。synthetic golden 已通过；HF immutable revision、real-screen
golden 和 final manifest 未闭合前，第 5 项 dependency 仍是 pending。
