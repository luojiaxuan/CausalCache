...
[`../../data/results/archive/restoration_v2_2_ocr_rgb_baseline_v2_identity_repair/`](../../data/results/archive/restoration_v2_2_ocr_rgb_baseline_v2_identity_repair/)。
...
/data/.venv/causalcache-ocr-v2/bin/python \
  ...
  --output-dir /data/CausalCache/data/results/archive/restoration_v2_2_ocr_rgb_baseline_v2_identity_repair
```
