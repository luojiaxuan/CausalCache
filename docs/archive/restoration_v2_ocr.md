...
见 [`data/results/archive/restoration_v2_ocr_backend/`](../../data/results/archive/restoration_v2_ocr_backend/)。
...
[`real_screen_summary.json`](../../data/results/archive/restoration_v2_ocr_backend/real_screen_summary.json)。confirm image、
