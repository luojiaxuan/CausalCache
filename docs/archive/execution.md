...
preflight；详情见
[`../../data/results/archive/set_utility_throughput_host_readiness_v1/`](../../data/results/archive/set_utility_throughput_host_readiness_v1/)。
...
`docs/archive/restoration_v2.md` 所列八项全部完成
...
`data/results/archive/restoration_v2_gpu_compute_audit/`；旧 GPU-0 结果保留在 Git history。该结果不是 GUI-Owl
...
canonical summary 位于 `data/results/archive/restoration_v2_processor_audit/summary.json`，SHA256
...
processor audit。re-anchor evidence 位于 `data/results/archive/restoration_v2_runtime_reanchor/`。GPU-2 execution
...
`docs/archive/restoration_v2_1_full_45.md`。
...
`data/results/archive/restoration_v2_constructor_preflight/`。冻结 interface manifest 保留 run 前 `pending`，实际
...
`data/results/archive/restoration_v2_executor_dispatch/`；该结果闭合第 4 项 action dependency，但不替代其余七项
...
python3 -m scripts.materialize_restoration_v2_selection \
  ...
  --v1-summary data/results/archive/independent_reference_gate_v1/summary.json \
...
`data/results/archive/restoration_v2_selection/`；dependencies 2/3 已闭合。该步骤未启动 GUI-Owl，也未产生任何
policy/restoration output。

OCR/image backend 是纯 CPU 数据步骤，不触发 GPU cleanup 或 utilization monitor。implementation contract、
exact runtime lock、model SHA 和 synthetic fixture 见 `docs/archive/restoration_v2_ocr.md`。Hyper00 staging 固定为
...
`data/results/archive/restoration_v2_ocr_backend/real_screen_summary.json`。这只闭合 dependency 5；baseline dependency
...
`data/results/archive/restoration_v2_derived_artifact/`。该里程碑结束时第 8 项 execution config 仍 pending，policy
inference 当时继续 locked。

executor dispatch 必须按 `docs/archive/restoration_v2_executor_dispatch.md` 先运行 host-side live Docker inspection，
...
本阶段的 source freeze 与唯一正式执行均已闭合，完整 contract 见 `docs/archive/restoration_v2_2_eager.md` 和
...
`data/results/archive/restoration_v2_2_eager_full_45_substrate/`。source-only validator 通过本身不授权 GPU run；本次
...
正式 argv 以 `docs/archive/restoration_v2_2_labels.md` 为唯一说明入口。terminal 后才可用
...
`data/results/archive/restoration_v2_2_eager_labels_v1_attempt/`。
...
存在，详见 [`../../data/results/archive/gate_v1_formal58_cache_v1_attempt/`](../../data/results/archive/gate_v1_formal58_cache_v1_attempt/)。
...
[`../../data/results/archive/gate_v1_formal58_cache_transport_repair_v1/`](../../data/results/archive/gate_v1_formal58_cache_transport_repair_v1/)
...
[`../../data/results/archive/gate_v1_formal58_train_v1/`](../../data/results/archive/gate_v1_formal58_train_v1/)。整个训练保持
...
[`../../data/results/archive/gate_v1_fresh16_evaluation_v1_attempt/`](../../data/results/archive/gate_v1_fresh16_evaluation_v1_attempt/) 和
...
[`../../data/results/archive/gate_v1_fresh16_failure_decomposition_v1/`](../../data/results/archive/gate_v1_fresh16_failure_decomposition_v1/)。
...
[`../../data/results/archive/independent_confirm20_failure_decomposition_v1/summary.json`](../../data/results/archive/independent_confirm20_failure_decomposition_v1/summary.json)。
