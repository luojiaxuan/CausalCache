...
- Git summary：
  `data/results/archive/set_utility_selected_image_format_census_v2_column_projection_repair/summary.json`；
...
- recorder handoff：`code/scripts/watch_set_utility_processor_freeze_v2_result.py` 只等待上述 supervisor 的原子终态，
  ...
  [`../../data/results/archive/set_utility_processor_freeze_v2_image_contract_repair/`](../../data/results/archive/set_utility_processor_freeze_v2_image_contract_repair/)；
- immutable publication：publication checkout 已更新为 clean detached
  ...
  [`../../data/results/archive/set_utility_processor_freeze_v2_image_contract_repair_publication_v1/`](../../data/results/archive/set_utility_processor_freeze_v2_image_contract_repair_publication_v1/)。临时 HF token 已从容器与本机临时路径删除；
...
- Git-safe 记录：`data/results/archive/set_utility_processor_execution_scaling_v2/`。GPU、model/policy forward、label、
...
[`../../data/results/archive/set_utility_processor_postflight_parallel_v1/`](../../data/results/archive/set_utility_processor_postflight_parallel_v1/)。
