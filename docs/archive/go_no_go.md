...
[`data/results/archive/independent_reference_gate_v1/`](../../data/results/archive/independent_reference_gate_v1/)，raw run 位于
...
confirm 未打开。轻量结论见
[`data/results/archive/restoration_v2_substrate_screening/`](../../data/results/archive/restoration_v2_substrate_screening/)。
