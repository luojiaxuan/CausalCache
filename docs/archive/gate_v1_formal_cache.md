...
> evidence 分别见 `data/results/archive/gate_v1_formal58_cache_v1_attempt/`、
> `data/results/archive/gate_v1_formal58_cache_transport_repair_v1/` 和
> `docs/archive/gate_v1_formal_cache_transport_repair.md`。
