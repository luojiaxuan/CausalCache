...
MVP-64 完成后，不改 feature、model family、hidden size、loss 或 teacher microbatch，只扩大同一 deterministic selection prefix：每 worker 77 train、6 tune、6 development-evaluation，共 356 states。科学输出仍逐 state 保存。
