...
[`capacity/prefetch summary`](../../data/results/archive/set_utility_capacity_and_prefetch_v1/README.md)。
...
轻量结果见
[`data/results/archive/set_utility_decision_distillation_v2_epoch1_tune/`](../../data/results/archive/set_utility_decision_distillation_v2_epoch1_tune/README.md)。
