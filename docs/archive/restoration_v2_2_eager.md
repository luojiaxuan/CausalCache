...
`bb6351e4dd5b4470ed1add86dbcbaa714a56063ba8ecf07268b6f13f630f9e54`。source-only validation 不读取
...
`data/results/archive/restoration_v2_2_eager_full_45_substrate/`。
