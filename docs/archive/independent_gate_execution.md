...
[`data/results/archive/independent_reference_gate_v1/`](../../data/results/archive/independent_reference_gate_v1/)。因此本文后续
...
`data/results/archive/ui_tars_hyper00_hardware_anchor/summary.json`。它不允许 independent run 复用旧 Qwen
...
/data/.venv/causalcache-independent-gate/bin/python -m scripts.run_independent_ui_tars_reference_gate \
  ...
  --hardware-anchor-summary data/results/archive/ui_tars_hyper00_hardware_anchor/summary.json \
