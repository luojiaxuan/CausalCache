...
- formal gate completion：[`data/results/archive/gate_v1_formal58_train_v1/`](../../data/results/archive/gate_v1_formal58_train_v1/)；
...
- versioned claim-serialization repair completion：
  ...
  [轻量结果](../../data/results/archive/gate_v1_fresh16_claim_serialization_repair_v1/) 与
