...
[`data/results/set_utility_processor_freeze_v2_image_contract_repair_publication_v1/summary.json`](../data/results/set_utility_processor_freeze_v2_image_contract_repair_publication_v1/summary.json)。正式执行只能读取与上述 revision 和
...
正式轻量结果预定写入 `data/results/set_utility_train_only_throughput_pilot_v1/`；在 envelope B
