"""Run the pre-registered UI-TARS full-history coverage gate."""
...
def main() -> None:
    ...
    with tarfile.open(args.dataset_tar) as archive:
        ...
        warmup_messages = build_ui_tars_messages(
            manifest,
    ...
    action_type_gate = all(by_action_type[action_type]["matches"] >= 1 for action_type in required_types)
