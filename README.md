...
| Selector-side GUI-Owl LoRA v1 | [设计](docs/set_utility_selector_lora_v1.md)；[状态](data/results/set_utility_selector_lora_v1/README.md) | teacher 不变；top-4 branch 单 context bitwise parity PASS；需生成约 23,714 contexts / 277GiB boundary cache |
