...
| Selector-side GUI-Owl LoRA v1 | [设计](docs/set_utility_selector_lora_v1.md)；[config](code/configs/causalcache_set_utility_selector_lora_v1.json)；[状态](data/results/set_utility_selector_lora_v1/README.md) | teacher 不变；top-4 replay parity PASS；boundary/adapter/LoRA 实现测试 14 passed；23,714-context cache 尚未生成 |
