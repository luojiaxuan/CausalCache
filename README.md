...
- formal label rollout 正在 Hyper00/Hyper01 的 8xH200 上运行：24 个 resumable workers、每卡 3 个 in-flight process。2026-07-20 01:43 UTC 已有 2,332/11,746 terminal states；实测速率约 28.3 states/min，剩余 ETA 5.5--7 小时。运行入口见 [`data/results/set_utility_variable_history_labels_v1/`](data/results/set_utility_variable_history_labels_v1/README.md)。
...
| Variable-history formal labels | [HF dataset](https://huggingface.co/datasets/gavinlaw/causalcache-set-utility-variable-history-mobile) | `RUNNING`；2,332/11,746 terminal states at 2026-07-20 01:43 UTC；完成后发布 immutable revision |
