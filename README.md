...
| 25% tuning snapshot/cache | Hyper00 `/data02/jaxan/artifacts/causalcache-set-utility-tuning25-train25-68527be`；`/data02/jaxan/artifacts/causalcache-set-utility-tuning25-cache-68527be` | 3,575 states；23GB；`PENDING_HF_UPLOAD`；[summary](data/results/set_utility_tuning25_v1/README.md) |
| 25% tuning checkpoints | Hyper00 `/data02/jaxan/runs/causalcache-set-utility-tuning25-v3-seeded-floor1e2-2d68154` | 12 configs / 453MB；`PENDING_HF_UPLOAD`；tuning-only |
