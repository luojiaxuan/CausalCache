...
- 正式 nested learning-curve inputs 已冻结：100/250/500/1,000 train trajectories，完整 100-trajectory tune 保持不变；full-token cache 在两台 Hyper 上得到相同 identity。执行入口见 [`data/results/set_utility_learning_curve_v1/`](data/results/set_utility_learning_curve_v1/README.md)。
