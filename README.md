...
| Budget-deferral evaluation Stage-A | [执行 config](code/configs/causalcache_set_utility_budget_deferral_evaluation_stage_a_v1.json)；[状态](data/results/set_utility_budget_deferral_evaluation_v1/README.md) | label-blind inputs complete；1,046 states / 2,492 contexts；truth read=0；11-GPU resumable extraction frozen；`PENDING_HF_UPLOAD` |
