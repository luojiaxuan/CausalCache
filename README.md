...
- full train+tune contextual requirement snapshot 已物化并同步两台 Hyper：11,721 states、1,100
  trajectories、27,867 contexts；仅等待 tune truth winner 后启动 12×H200 hidden extraction，不访问 evaluation。
...
| Contextual full inputs v4 | Hyper00/Hyper01 `/data02/jaxan/artifacts/causalcache-contextual-inputs-full-v4-f65ecba` | 11,721 states；27,867 contexts；content `af18388e...139c1`；`PENDING_HF_UPLOAD` |
