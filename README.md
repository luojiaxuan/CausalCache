...
| arXiv 作者预览与源码包 | [`paper/main_arxiv.tex`](paper/main_arxiv.tex)；[`paper/package_arxiv.sh`](paper/package_arxiv.sh) | 与 `main.tex` 共用完整正文；显示 5 位作者，单位信息待确认；`make arxiv arxiv-source` 可复现，尚未向 arXiv 提交 |
