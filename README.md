...
| arXiv 作者预览与源码包 | [`paper/main_arxiv.tex`](paper/main_arxiv.tex)；[`paper/package_arxiv.sh`](paper/package_arxiv.sh) | 与 `main.tex` 共用完整正文；`make arxiv arxiv-source` 可复现；2026-08-23 已提交为 `submit/7983880`（`cs.AI`、无 cross-list、arXiv non-exclusive license），状态 `submitted`，公开 arXiv identifier 待审核/公告后回填 |
