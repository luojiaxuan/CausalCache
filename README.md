...
| Direct marginal v3 Stage-B v1 | [合同](docs/set_utility_direct_marginal_v3_stage_b_v1.md)；[config](code/configs/causalcache_set_utility_direct_marginal_v3_stage_b_v1.json)；Hyper00 `/data02/jaxan/runs/causalcache-direct-marginal-v3-stage-b-v1-8ccdb5c` | `RUNNING`；5,550 states / 62,332 groups；Hyper00 8-rank DDP；每 epoch resumable；`PENDING_HF_UPLOAD` |
